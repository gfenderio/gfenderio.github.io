...
const translations = {
    en: {
        ...
        "work.code": "View code",
        "work.kasirin.desc": "An enterprise-grade POS for high-traffic minimarkets (50k+ SKUs). Offline-first so checkout never stops when the WiFi drops, real-time inventory over SSE, atomic transactions that prevent overselling, and AI restock alerts from a Brain.js neural network.",
        "work.itungin.desc": "A mobile-first personal finance app: a smart dashboard with cash-flow charts, debt tracking with a debt-to-income health score, category budgets with live warnings, and recurring-bill reminders — wrapped with Capacitor for a native Android build.",
        ...
        "exp.indie.desc": "Conceptualized and built my own applications — Kasirin (enterprise POS) and Itungin (mobile finance app) — using AI-assisted development to ship full-stack features with Next.js, React, and TypeScript, and to test for stability and accuracy.",
    ...
    id: {
        ...
        "work.kasirin.desc": "POS kelas enterprise untuk minimarket ber-trafik tinggi (50rb+ SKU). Offline-first sehingga transaksi tetap jalan walau WiFi mati, stok real-time via SSE, transaksi atomik anti-oversell, dan alarm restock cerdas dari neural network Brain.js.",
        "work.itungin.desc": "Aplikasi keuangan pribadi mobile-first: dashboard pintar dengan grafik arus kas, pelacak utang dengan skor debt-to-income, anggaran per kategori dengan peringatan langsung, dan pengingat tagihan rutin — dibungkus Capacitor untuk build Android native.",
        ...
        "exp.indie.role": "Independent Developer",
        "exp.indie.desc": "Merancang dan membangun aplikasi sendiri — Kasirin (POS enterprise) dan Itungin (app keuangan mobile) — memakai pengembangan berbantuan AI untuk merilis fitur full-stack dengan Next.js, React, dan TypeScript, serta menguji stabilitas dan akurasi.",
        "exp.informa.role": "Sales Executive &amp; Assistant Product Specialist",
