...
const translations = {
    ...
    id: {
        ...
        "about.title": "Tentang.",
        "about.p1": "Saya menghabiskan bertahun-tahun di operasional retail — memimpin operasional toko dan departemen, mengejar target penjualan, serta menjaga akurasi stok dan harga. Dari sana saya paham betul di mana sebuah bisnis kehilangan waktu, dan di mana software yang tepat benar-benar terbayar.",
        "about.p2": "Sekarang saya yang membangun software itu. Di Kyou saya memetakan alur kerja gudang, logistik, dan e-commerce lalu merombaknya menjadi sistem otomatis — memadukan AI engineering dengan fondasi teknis yang kuat untuk memangkas kerja manual dan kesalahan manusia. Saya merilis produk full-stack secara menyeluruh, dan menulis web dengan rapi: kode siap produksi, bukan sekadar asal jadi.",
        "about.p3": "Saya mahasiswa Sistem Informasi yang belajar lewat berkarya. Hasil kerjanya nyata dan sudah berjalan di produksi; targetnya terus menaikkan standar. Kalau Anda butuh orang yang paham sisi operasional sekaligus codebase-nya, mari bicara.",
